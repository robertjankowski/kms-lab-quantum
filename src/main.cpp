...
int main() {
    ...
    for (int i = 0; i < 1; ++i) {
        ...
        const std::string metricsFile = getCustomFilename(basePath, "metrics_no_resonance", kappa, step, 1);
        const std::string densityFile = getCustomFilename(basePath, "density_no_resonance", kappa, step, 1);
