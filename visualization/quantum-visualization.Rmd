...
```{r, fig.width=14, fig.height=5}
o1 <- ggplot() + 
  geom_line(data = omega_n_1_k_1, aes(omega, Energy, color = "n=1,k=1")) + 
  geom_line(data = omega_n_1_k_3, aes(omega, Energy, color = "n=1,k=3")) + 
  geom_line(data = omega_n_1_k_5, aes(omega, Energy, color = "n=1,k=5")) + 
  geom_line(data = omega_n_1_k_7, aes(omega, Energy, color = "n=1,k=7")) + 
  geom_line(data = omega_n_1_k_9, aes(omega, Energy, color = "n=1,k=9")) + 
  geom_vline(xintercept = 3 * pi * pi / 2, color = "red") + 
  geom_vline(xintercept = 4 * pi * pi / 2, color = "green") + 
  geom_vline(xintercept = 8 * pi * pi / 2, color = "blue") + 
  theme_light()
...
omega_n_9_k_20 <- read_csv("../output/new_resonanse/kappa_20_omega_1_n_9.txt", col_names = F)
...
colnames(omega_n_9_k_20) <- c("omega", "Energy")
```
